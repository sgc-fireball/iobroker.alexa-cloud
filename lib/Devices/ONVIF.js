...
class ONVIF extends BaseDevice {
    ...
    getHighStreamUrl(width, height) {
        return 'rtsp://.../iobroker/alexa-cloud/streams/' + this.getEndpointId();
    ...
    getSnapshotUrl() {
        return 'https://.../iobroker/alexa-cloud/snapshots/' + this.getEndpointId();
