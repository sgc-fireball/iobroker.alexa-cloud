    ...
    handleAuthorization(request) {
        ...
        try {
            ...
            this.adapterUtils.postForm(
                ...
                .then(body => {
                    this.adapter.log.info('TOKEN RESPONSE: ' + JSON.stringify(body));
                ...
                .catch((e) => {
                    this.adapter.log.error('handleAuthorization: ' + JSON.stringify(e));
                })
        ...
        this.adapter.log.log('handleAuthorization accepted');
