    ...
    refreshAccessToken() {
        return new Promise((resolve, reject) => {
            this.adapter.getState('info.refresh_token', (err, refresh_token) => {
                this.adapter.log.warn('refresh_token-err: '+(!!err ? err.toString() : JSON.stringify(err)));
                this.adapter.log.warn('refresh_token: '+(!!refresh_token ? refresh_token.toString() : JSON.stringify(refresh_token)));
