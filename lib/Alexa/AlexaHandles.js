...
class AlexaHandles {
    ...
    handleRequest(request) {
        ...
        this.adapter.log.info('handleRequest: try ' + namespace + ' with ' + method);
    ...
    handleEvent(event) {
        ...
        this.adapter.log.info('handleEvent: try ' + name + ' with ' + method);
        if (typeof (this[method]) === "function") {
    ...
    handleUnknown(request) {
        this.adapter.log.info('handleUnknown: ' + JSON.stringify(request));
