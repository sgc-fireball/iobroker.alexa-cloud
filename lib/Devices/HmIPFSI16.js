...
// Homematic IP Smart Home Schaltaktor mit Tastereingang (16 A)

class HmIPFSI16 extends BaseHomeMaticDevice {

    power(value = null) {
        if (value === null) {
            return this.getState(this.id + '.3.STATE');
        }
        this.setState(this.id + '.3.STATE', !!value);
    }
